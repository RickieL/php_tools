...
class PageXml extends APageFactory
{
	 ...
	 */
	public function output($fetch = false)
	{
	 ...
	 * @return string
	 */
	public function &serializeXml(&$data, $level = 0, $priorKey = NULL)
	{
		$serializedXmlString = '';
		...
		if ($level == 0)
		{
			$serializedXmlString = '<?xml version="1.0" encoding="' . $this->app->cfg['page']['charset'] . '"?>' . "\r\n" . $serializedXmlString;
		}
