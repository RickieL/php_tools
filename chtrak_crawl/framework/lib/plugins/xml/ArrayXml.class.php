...
class ArrayXml
{
	 ...
	 * @static 
	 */
	public static function loadFromFile($filename, $startNode = '')
	{
		if (is_file($filename))
		{
	 ...
	 * @static 
	 */
	public static function saveToFile($filename, $xml, $root = '')
	{
	 ...
	 * @static 
	 */
	public static function nodeInit(& $xml, $nodes)
	{
	 ...
	 * @static 
	 */
	public static function indexOf(& $haystack, $needle, $field = '')
	{
		toArray($haystack);
	 ...
	 * @static 
	 */
	public static function nodeDelete(& $haystack, $needle, $field = '%INDEX%')
	{
	 ...
	 * @static 
	 */
	public static function nodeInsert(& $haystack, $new_node, $needle, $field = '', $before = false)
	{
		$result = false;
	 ...
	 * @static 
	 */
	public static function nodeMove(& $haystack, $needle, $field = '', $flag = 'up')
	{
	 ...
	 * @static 
	 */
	public static function &serializeXml(&$data, $level = 0, $priorKey = NULL)
	{
		$serializedXmlString = '';
	 ...
	 * @static 
	 */
	public static function &unserializeXml($string)
	{
